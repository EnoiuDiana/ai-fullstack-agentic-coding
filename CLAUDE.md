...
- Admin: `admin@onlineshop.com`
- Customer: `john.doe@email.com` or `jane.smith@email.com`
...
**Prerequisites:** Enable annotation processing in your IDE (required for Lombok).
...
Runs on `http://localhost:4200/` and connects to API at `http://localhost:3000/api` (hardcoded in environment.dev.ts).
